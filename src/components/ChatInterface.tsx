      ...
      <div className="p-4 border-t bg-gray-50 rounded-b-lg">
        <div className="flex gap-3">
          ...
          <button
            ...
            className="px-10 py-1 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center"
            title="送信"
          >
